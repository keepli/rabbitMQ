...
public class RabbitMQTopic {
    ...
    public static final String Queue_NAME1 = "boot_topic_queue1";
    public static final String Queue_NAME2 = "boot_topic_queue2";
    ...
    public Binding bindingQueueExchange2(@Qualifier(Queue_NAME2) Queue queue, @Qualifier(EXCHANGE_NAME) Exchange exchange){
        return BindingBuilder.bind ( queue ).to ( exchange ).with ( "good.*" ).noargs ();
    }
}
